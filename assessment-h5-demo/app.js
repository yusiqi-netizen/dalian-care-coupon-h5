const screens = [
  ...
  { image: "最长发声时间测试倒计时 5 秒.png", countdown: true },
  ...
  { image: "单腿站立测试前倒计时 5 秒.png", countdown: true },
  { image: "单腿站立测试中.png", audio: "test-start-speech.mp3" },
  { image: "单腿站立测试完成.png" },
  { image: "计时走测试.png" },
  { image: "计时走测试前倒计时 5 秒.png", countdown: true },
...
detailView.addEventListener("click", event => {
  ...
  if (action === "back-report") { detailView.hidden = true; stage.hidden = false; renderScreen(); }
